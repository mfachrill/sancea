    ...
    <header className="sticky top-0 z-30 border-b border-border bg-background/95 backdrop-blur">
      <div className="mx-auto flex h-20 max-w-[84rem] items-center justify-between px-5 md:px-10">
        <Link to="/" aria-label="Sancea home" className="text-ink">
          <div className="font-display text-[1.4rem] leading-none tracking-[0.22em]">SANCEA</div>
          <div className="mt-1 text-[0.52rem] uppercase tracking-[0.3em] text-gold-dark">Kebaya & Makeup</div>
        </Link>
